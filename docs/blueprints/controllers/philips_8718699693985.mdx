...
description: Controller automation for executing any kind of action triggered by the provided Philips Hue Smart Button. Supports deCONZ, ZHA.
---
...
This blueprint provides universal support for running any custom action when a button is pressed on the provided Philips Hue Smart Button. Supports controllers integrated with deCONZ, ZHA. Just specify the integration used to connect the remote to Home Assistant when setting up the automation, and the blueprint will take care of all the rest.
...
/>
<Input
  name='Long button press - Maximum loop repeats'
...
- **2021-07-03**: first blueprint version :tada:
