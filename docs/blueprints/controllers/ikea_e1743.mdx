...
Two different control schemes are available for this dimmer. Choosing the corresponding entry in the Light Hook configuration will result in the below button control.

#### IKEA E1743 On/Off Switch & Dimmer - Default (Mapping 1)
...
#### IKEA E1743 On/Off Switch & Dimmer - Mapping 2

- Up button short press -> Brightness up (turn lights on if off)
- Up button long press & hold -> Brightness up (continuous, until release)
