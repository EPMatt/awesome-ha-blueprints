...
- Up button double press -> Brightness up
- Up button release -> Color up
- Down button short press -> Turn off
- Down button double press -> Brightness down
- Down button release -> Color down
...
- **2021-10-28**: first blueprint version :tada:
