...
- [IKEA ICTC-G-1 TRADFRI wireless dimmer](/docs/blueprints/controllers/ikea_ictc_g_1)
- [Osram SMART+ Switch Mini](/docs/blueprints/controllers/osram_ac025xx00nj)
- [Philips Hue Dimmer switch](/docs/blueprints/controllers/philips_324131092621)
- [Philips Hue Smart Button](/docs/blueprints/controllers/philips_8718699693985)
...
- **2021-08-22**:
  - Added mapping functionality to allow multiple mappings for a remote. Refer to documentation of your controller for details.
  - Fix for remembering brightness level when turning on, where brightness level unavailable when light off
  - IKEA E1743 On/Off Switch & Dimmer added 2nd Mapping to allow using short press of up/down as either on/off or dimming when lights are on. Single press still turns on when in Dimming mode and double press will turn lights off.
  - Version information now visible in blueprint description
