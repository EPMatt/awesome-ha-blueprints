...
- **2021-08-18**:
  ...
  - **breaking change**: IKEA E1743 On/Off Switch & Dimmer 2 different functionalities provided for E1743 to allow option of using short press of up/down as either on/off or dimming when lights are on. Single press still turns on when in Dimming mode and double press will turn lights off.
