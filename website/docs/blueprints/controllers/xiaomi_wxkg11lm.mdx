---
title: Controller - Xiaomi WXKG11LM Aqara button
description: Controller automation for executing any kind of action triggered by the provided Xiaomi WXKG11LM Aqara button. Supports deCONZ, ZHA, Zigbee2MQTT.
---
